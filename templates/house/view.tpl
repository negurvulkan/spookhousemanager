        ...
        {if $selectedFloorId}
            {if $floorLayout}
                <div class="house-grid-wrapper" role="img" aria-label="Rasterdarstellung Ebene {$selectedFloorId}">
                    <canvas
                        class="house-grid-canvas"
                        width="{$floorLayout.svgWidth}"
                        height="{$floorLayout.svgHeight}"
                        data-wall-renderer="true"
                        data-floor-id="{$selectedFloorId|escape}"
                        data-api-endpoint="/api/get_floor_walls.php"
                        data-cell-size="32"
                    ></canvas>
                    <div class="house-grid-overlay">
                        <svg class="house-grid-svg" viewBox="0 0 {$floorLayout.svgWidth} {$floorLayout.svgHeight}" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
